  ...
  downloads: {
    ...
    fields: [F('title', 'Title', 'text', { required: true }), F('date', 'Date', 'date'), F('category', 'Category'),
             F('section', 'Section', 'select', { required: true, options: [
               ...
               { value: 'niper-ranks', label: 'Student Achievements — NIPER Ranks' },
               { value: 'gpat-ranks', label: 'Student Achievements — GPAT Ranks' },
               { value: 'appgecet-ranks', label: 'Student Achievements — APPGECET Ranks' },
               { value: 'career-guidance-placement-cell', label: 'Student Corner — Career Guidance/Placement Cell' },
               { value: 'grievance-redressal-cell', label: 'Student Corner — Grievance Redressal Cell' },
               { value: 'students-committees', label: 'Student Corner — Students & Committees' },
             ] }),
